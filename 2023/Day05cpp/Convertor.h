...
public:
        ...
        for (std::tuple<long long, long long>& range : inRanges)
        {
            ...
            for (std::tuple<long long, long long, long long>& tup : _listOfRules)
            {
                ...
                if (sizeinter != 0)
                {
                    ...
                    outRanges.push_back({ outBegRange + begInter- inBegRange,sizeinter });
                }
            }
    ...
    static void AddNotMappedParts(std::vector<std::tuple<long long, long long>>& outRanges, std::tuple<long long, long long>& range, std::vector<std::tuple<long long, long long>>& inters)
    {
